...
class ForecastModel
{
    ...
    private $_hourlyRecordedTemperature;
	  ...
	  /**
     * @var array Array with hourly recorded dew point
     */
    private $_hourlyRecordedDewPoint;
    ...
    private $_hourlyHumidity;
	 ...
	 /**
     * @var array Array with hourly dew point
     */
    private $_hourlyDewPoint;
     ...
     * @return array
     */
    public function getHourlyRecordedDewPoint()
    {
        return $this->_hourlyRecordedDewPoint;
    }

    /**
     * @param array $hourlyRecordedDewPoint
     */
    public function setHourlyRecordedDewPoint($hourlyRecordedDewPoint)
    {
        $this->_hourlyRecordedDewPoint = $hourlyRecordedDewPoint;
    }
     ...
     * @return array
     */
    public function getHourlyDewPoint()
    {
        return $this->_hourlyDewPoint;
    }

    /**
     * @param array $hourlyDewPoint
     */
    public function setHourlyDewPoint($hourlyDewPoint)
    {
        $this->_hourlyDewPoint = $hourlyDewPoint;
    }
    ...
    private function _aggregateWeatherData($date, $timeInterval, $daylight)
    {
			...
			$aggregateData['recorded_dewpoint'] = $this->_averageValues($date, $timeInterval, $this->_hourlyRecordedDewPoint);
            ...
            $aggregateData['humidity']             = $this->_averageValues($date, $timeInterval, $this->_hourlyHumidity);
			 $aggregateData['dewpoint']             = $this->_averageValues($date, $timeInterval, $this->_hourlyDewPoint);
